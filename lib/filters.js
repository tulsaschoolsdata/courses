...
import { schoolsWhereCategoryCode, schoolFindById } from '/lib/models'
import { creditTypes } from './../lib/models/credit_types'
...
export default function Filters({
  ...
  const credit_types = creditTypes()
  ...
  const getLabel = (selected) => {
    const match = credit_types.find((type) => type[0] === selected)
    return match[1].name
  }
