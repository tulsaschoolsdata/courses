  ...
  return (
    <Stack spacing={1}>
      ...
      <FormControl fullWidth>
        ...
        <Select multiple label="Select department(s)" value={filters.departments} onChange={option => handleChange('departments', option.target.value)}>
      ...
      <FormControl fullWidth>
        ...
        <Select multiple label="Select school(s)" value={filters.schools} onChange={option => handleChange('schools', option.target.value)}>
          {schools.map(school => (
