describe('courses show page', () => {
  ...
  it('displays course #', () => {
    cy.getBySel('showCourse').last().should('contain.text', 'Course #: 30274')
  })

  it('displays department', () => {
    cy.getBySel('showCourse').last().should('contain.text', 'CTE: STEM')
  })

  it('displays credit type', () => {
    cy.getBySel('showCourse').last().should('contain.text', 'Credit Type: ELEC')
  })

  it('displays credit hours', () => {
    cy.getBySel('showCourse').last().should('contain.text', 'Credit Hours: 1')
  })

  it('displays course description', () => {
    cy.getBySel('showCourse').last().should('contain.text', 'Test Description')
  })
